...
> 路径均从 locus 根（仓库根）起，写完整相对路径。

工程管理：
- projects/locus-meta/CHANGELOG.md — 阶段/变更记录

记忆：
- projects/locus-meta/current.md / index.md / entries/

设计文档（本体，docs/）：
- projects/locus-meta/docs/minimal-memory.md — 极简记忆方案（当前记忆契约）
