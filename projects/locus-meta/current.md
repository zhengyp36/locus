...
- 记忆/管理协议：极简记忆契约（指令两条、更新=重写、摘要+索引、细节入 entries；projects 分工程 + active 指针 + timeline）+ 两层模型（管理层=确定锚、记忆层=类人印象；大写=管理/小写=记忆）+ 目录整理（顶层 README 给 AI、docs/ 为本体）。→ projects/locus-meta/entries/2026-08-14-locus-meta-structure.md + projects/locus-meta/docs/minimal-memory.md + projects/locus-meta/docs/design-v2.md
...
- token 消耗（样本 cogos 联调 101K）：四条根因 + 四个方案；中文比英文贵约 1.4x。→ projects/locus-meta/docs/token-cost-analysis.md + projects/locus-meta/docs/language-token-cost.md
