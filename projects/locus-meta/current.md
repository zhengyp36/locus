...
- token 消耗（样本 cogos 联调 101K）：四条根因 + 四个方案；中文比英文贵约 1.4x。→ projects/locus-meta/docs/token-cost-analysis.md + projects/locus-meta/docs/language-token-cost.md + projects/locus-meta/docs/token-cost-implementation.md（实施计划：阶段1完成、阶段2定稿待执行）
