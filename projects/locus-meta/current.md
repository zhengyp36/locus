...
- 两层模型（管理 vs 记忆）：工程管理层（README/CHANGELOG/ROADMAP，大写、确定、追加、不重写）vs 记忆层（current/index/entries，小写、重写、可乱）；CHANGELOG 人显式指出、阶段完成时更新；命名约定子工程内大写=管理/小写=记忆。→ entries/2026-08-14-locus-meta-structure.md
