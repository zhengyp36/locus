...
- 2026-09-27 — 规则重构：按"讨论期 vs 执行期"分两文件（`AGENTS.md` 常驻基线 + `rules/task.md` 执行期），旧 memory/handoff/screenlab 解散、环境数据迁 cogos tools；详见 projects/locus-meta/entries/2026-09-27-rules-restructure.md。
