...
- **#15~#18 推演链**（未入 entries，交接在归档）：动因证伪 → 感知/身份/事件驱动 → 运行框架/流与时间线 → 经历表示/切点=误差/取回内容寻址/整理=抽样重演；总纲 `../cogos/docs/design-selfdrive-agent.md`，过程 `checkpoint/26-09-17-agent-theory/`。
