...
> 更新：2026-08-20（新方法：目的优先 + 状态轴）| 本体：`../cogos`
...
| 4 双 bot 群 + @all | bs_agent（建群/MEET/refresh/query_contact_chat_id）/ agent_conn（resolve_target/make_session/route_message）/ session_naming（fix_group_p2p 写 peer_number）/ groupmgr（手动）| 兑现 |
